...
func _on_button_pressed():
	...
	get_node("../../item_info/item_description").text =  "Name : %s \n%s\nStats : %s Damage, %s Defense, %s Health" % [item_info.item_name,item_info.description,item_info.item_damage,item_info.item_defense,item_info.item_health]
