...
func build_wireframe_hypercube_mesh(vertices) -> Mesh:
	...
	for edge in get_hypercube_edges():
		var p1 = project_to_3d_orhtogonale(vertices[edge[0]])
		var p2 = project_to_3d_orhtogonale(vertices[edge[1]])
...
func build_solid_hypercube_mesh(vertices) -> Mesh:
	...
	for cube in get_hypercube_cubes():
		for face in CUBE_FACES:
			var p1 = project_to_3d_orhtogonale(vertices[cube[face[0]]])
			var p2 = project_to_3d_orhtogonale(vertices[cube[face[1]]])
			var p3 = project_to_3d_orhtogonale(vertices[cube[face[2]]])
			var p4 = project_to_3d_orhtogonale(vertices[cube[face[3]]])
