...
@export var object_controlled : Node = null
var transformation_tab = [];
var current_tab :int = 0;


@onready var translation_sliders : Array[HSlider] = [$ReferenceRect/ColorRect/HBoxContainer/Translation/VBoxContainer/HBoxContainer/translation_x_slider,
$ReferenceRect/ColorRect/HBoxContainer/Translation/VBoxContainer/HBoxContainer2/translation_y_slider,
$ReferenceRect/ColorRect/HBoxContainer/Translation/VBoxContainer/HBoxContainer3/translation_z_slider,
$ReferenceRect/ColorRect/HBoxContainer/Translation/VBoxContainer/HBoxContainer4/translation_w_slider
]

@onready var dimension_check_box : OptionButton = $ReferenceRect/ColorRect/HBoxContainer/Fez/OptionButton
...
func _ready():
	xy_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer/xy_rotation_button
	xz_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer3/xz_rotation_button
	yz_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer5/yz_rotation_button
	xw_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer2/xw_rotation_button
	yw_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer4/yw_rotation_button
	zw_rotation_button = $ReferenceRect/ColorRect/HBoxContainer/Rotation/GridContainer/HBoxContainer6/zw_rotation_button
	...
	transformation_tab.append($ReferenceRect/ColorRect/HBoxContainer/Translation)
	transformation_tab.append($ReferenceRect/ColorRect/HBoxContainer/Rotation)
...
func hide_and_show():
	if object_controlled:
		for i in range(transformation_tab.size()):
			if i != current_tab:
				transformation_tab[i].hide()
		transformation_tab[current_tab].show()
		$ReferenceRect/ColorRect/HBoxContainer/Init.hide()
	else:
		$ReferenceRect/ColorRect/HBoxContainer/Init.show()
		for transformation in transformation_tab:
			transformation.hide()
...
func _on_left_button_pressed():
	if(current_tab>0):
		...
		current_tab = transformation_tab.size()-1
	hide_and_show()


func _on_right_button_pressed():
	if(current_tab<transformation_tab.size()-1):
		current_tab=current_tab+1
	else :
		current_tab =0
	hide_and_show()
